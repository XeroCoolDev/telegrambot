  ...
  <div class="page">
    ...
    <template v-else>
      ...
      <div class="card">
        ...
        <div class="card-row" v-if="user.xui_username">
        ...
        <div class="card-row">
          <span class="card-label">Last Active</span>
          <span class="card-value" style="font-size: 13px">{{ user.last_accessed || 'Never' }}</span>
        </div>
      </div>
